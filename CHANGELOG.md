...
## [25.1.0-surge](https://github.com/jmadibekov/raiko/compare/v25.0.0-surge...v25.1.0-surge) (2026-02-27)


### Features

* add cached_event_data to ProofRequest and BatchPreflightData for optimized RPC calls ([494d307](https://github.com/jmadibekov/raiko/commit/494d30772711b09d9fdd9f50371b9665a44b88a3))
* add cached_event_data to ProofRequest and BatchPreflightData for optimized RPC calls ([246bf98](https://github.com/jmadibekov/raiko/commit/246bf98a85d24092a38905cf082870dbdc21bf71))
* add L2 grandparent header handling for Shasta batch processing ([#651](https://github.com/jmadibekov/raiko/issues/651)) ([8ea1d00](https://github.com/jmadibekov/raiko/commit/8ea1d00f136647fc3c11f4d17a7b369bdc8d3df7))
* add last anchor block number to various structures and functions ([f04d64a](https://github.com/jmadibekov/raiko/commit/f04d64ac13be4e9ecd1b6419d73e22312fabf9bb))
* add proposal block number retrieval and enhance shasta validation checks ([2f14d8d](https://github.com/jmadibekov/raiko/commit/2f14d8d62f0263563cecaad1655c876a410b1e67))
* alethia-reth updated ([812a423](https://github.com/jmadibekov/raiko/commit/812a4233049ac4e3f5e3d01fecc8230b961bf91e))
* alethia-reth updated ([c9f08bb](https://github.com/jmadibekov/raiko/commit/c9f08bbdad10707d4082875d57e3f77d44764486))
* anchorV4 fixed ([89a4759](https://github.com/jmadibekov/raiko/commit/89a4759c8fa7863ebce2362cac219c8f80b0e737))
* Cargo.lock update ([72a00ec](https://github.com/jmadibekov/raiko/commit/72a00ec0709e01117001ffe2fcd24f4428e642aa))
* check prev anchor block number in the first block of the proposal ([dea9c1c](https://github.com/jmadibekov/raiko/commit/dea9c1cc74283acb864d7aad0212ecf643d630a1))
* cobine semaphore and gpu_number logic in reqactor ([b3d96c3](https://github.com/jmadibekov/raiko/commit/b3d96c34dfd0e8aa624b07697f8bfff348150e35))
* decrease sgx-guest-docker enclave size ([d5cd6f8](https://github.com/jmadibekov/raiko/commit/d5cd6f8d341a4e1ea320d58ce077781f066cb6cb))
* enhance fork verifier address retrieval with block timestamp ([b3f1f46](https://github.com/jmadibekov/raiko/commit/b3f1f463209c6078b796301031b4131b0d60006e))
* enhance fork verifier address retrieval with block timestamp ([b0d1e3f](https://github.com/jmadibekov/raiko/commit/b0d1e3f5bbc0357aa0858c50d5c1e9672af30671))
* enhance Shasta aggregation functionality ([#650](https://github.com/jmadibekov/raiko/issues/650)) ([c1d2927](https://github.com/jmadibekov/raiko/commit/c1d292754cb8a0b50912855a51f5dd69e63aa0ca))
* enhance Shasta proposal API structure and hashing logic ([797525a](https://github.com/jmadibekov/raiko/commit/797525a458bd8df90a1eb8dc28a168d500da38a0))
* enhance Shasta proposal API structure and hashing logic ([326d63a](https://github.com/jmadibekov/raiko/commit/326d63a1cb822cd3a1ad1fae7c245d207e223af0))
* enhance Shasta proposal stress script with caching and batch querying ([a676cb1](https://github.com/jmadibekov/raiko/commit/a676cb1b78e4d1d9d1d0a165f732589e21b5bbfa))
* enhance Shasta proposal structure with parent transition hash and checkpoint to sync with latest taiko-mono ([6e69b98](https://github.com/jmadibekov/raiko/commit/6e69b98f104410fd27f6420feb29826e1c7e802f))
* enhance Shasta proposal structure with parent transition hash and checkpoint to sync with latest taiko-mono ([7324f8c](https://github.com/jmadibekov/raiko/commit/7324f8cf9b0e43febaa5b2fdb0178f4485d2f92e))
* enhance Taiko chain batch input handling for Shasta and Pacaya forks ([0b056f6](https://github.com/jmadibekov/raiko/commit/0b056f6d6879f4727eafb044f33044658900063b))
* impl hash_public_input function and update shasta_aggregation_output ([407e031](https://github.com/jmadibekov/raiko/commit/407e031a2386d7159834be4f9ff6a6550a9cb1e6))
* impl hash_public_input function and update shasta_aggregation_output ([ab07d2c](https://github.com/jmadibekov/raiko/commit/ab07d2cdf3c1ca6fd746f1316fe0fce428ba541b))
* implement gas limit validation for Shasta blocks ([3e7acae](https://github.com/jmadibekov/raiko/commit/3e7acaef6eb80258e489db5f00ea29d58d61cf4e))
* implement gas limit validation for Shasta blocks ([e2b2448](https://github.com/jmadibekov/raiko/commit/e2b2448f700c035c8a8c2780ab71cb9b365e3758))
* implement proposal hashing and enhance batch processing logic ([c658cdb](https://github.com/jmadibekov/raiko/commit/c658cdbbc732ad913a7c040db03ea00d3cb72b03))
* implement proposal hashing and enhance batch processing logic ([a4b9f46](https://github.com/jmadibekov/raiko/commit/a4b9f469931c7e31032a2a1b24c5f8cd949468ae))
* implement Shasta proof request handling and batch processing ([1621808](https://github.com/jmadibekov/raiko/commit/16218082132654185ffa123408cc189e18414515))
* implement Shasta proof request handling and batch processing ([e2e86e3](https://github.com/jmadibekov/raiko/commit/e2e86e3d30831c52f4def0fc6feafd23f4b83d0a))
* integrate zk support into shasta fork ([#640](https://github.com/jmadibekov/raiko/issues/640)) ([bde569d](https://github.com/jmadibekov/raiko/commit/bde569deff9d4de47bddab10fd7d35291ffcc2b8))
* introduce bond proposal hash handling for shasta fork ([d2d47df](https://github.com/jmadibekov/raiko/commit/d2d47df54210e5e47a30a3499b9027f2b3816a55))
* mock-mode added to sp1 and risc0 ([2e5a2c3](https://github.com/jmadibekov/raiko/commit/2e5a2c318bb8992320adc482ca63f4136b61bb91))
* post-merge fixes ([56ee2b8](https://github.com/jmadibekov/raiko/commit/56ee2b8d3aa69b7da602cc22c32b3fd2a0413062))
* **raiko:** build shasta infra ([2bd4aa6](https://github.com/jmadibekov/raiko/commit/2bd4aa6bc3216c049893bfae7fc65201fc6bd882))
* **raiko:** build shasta infra ([352c2c9](https://github.com/jmadibekov/raiko/commit/352c2c985d2ecd85bfa0cc5574dd3e989eebc5b8))
* **raiko:** support proof carry data to sync with latest shasta devnet ([#645](https://github.com/jmadibekov/raiko/issues/645)) ([c96f18c](https://github.com/jmadibekov/raiko/commit/c96f18c6d760823700b8a02032b217fea119522f))
* refine actual_prover and designated_prover in ProofRequest and update related logic ([5ed7db2](https://github.com/jmadibekov/raiko/commit/5ed7db28c388904740e267b86e9c1146ddca9315))
* refine actual_prover and designated_prover in ProofRequest and update related logic ([786a388](https://github.com/jmadibekov/raiko/commit/786a3884b911f8b7332dba1bfe3680f797606320))
* shasta tdx ([#47](https://github.com/jmadibekov/raiko/issues/47)) ([3b2ac8d](https://github.com/jmadibekov/raiko/commit/3b2ac8d5fd83ea271aef75448860e081fabfca37))
* update .env.sample.zk ([00c39c1](https://github.com/jmadibekov/raiko/commit/00c39c1eaad3197c5350807a4faec6d70681e4c8))
* update alethia-reth ([eb6a473](https://github.com/jmadibekov/raiko/commit/eb6a473b73b0bd5448d3ac27bc5d5a6d27a173ea))
* update configs ([64d94ce](https://github.com/jmadibekov/raiko/commit/64d94ce58eba5b77700dcc96c87f0fc6137d312f))
* update repo for sgx docker ([6a5a0b9](https://github.com/jmadibekov/raiko/commit/6a5a0b9e43d94c03e7f2abb60bfd3bea5976091e))
* update reth dependency for timestamp based fork choice ([8d6822c](https://github.com/jmadibekov/raiko/commit/8d6822ca691d966df4f09727e4c73e4fd94d927e))
* update reth dependency for timestamp based fork choice ([801915b](https://github.com/jmadibekov/raiko/commit/801915ba86caa0387f38cdeae25de6fbe0ca86eb))
* update risc0 Cargo.lock ([52a392f](https://github.com/jmadibekov/raiko/commit/52a392ff9b8c136c192ee0d952c86cb3e5b02c8d))
* updated alethia-reth crate ([e992dc4](https://github.com/jmadibekov/raiko/commit/e992dc45e164a51d6b23b27bc9470960b2078a47))
* use a wrapper ShastaProposalCheckpoint in API ([e0f8e77](https://github.com/jmadibekov/raiko/commit/e0f8e770135e597f8bd1f1fe98c9686dd1cf2299))
* use a wrapper ShastaProposalCheckpoint in API ([038da41](https://github.com/jmadibekov/raiko/commit/038da4118730ef1931a1c3bc9dbc07c48f93d67d))


### Bug Fixes

* boundless aggregation proof mismatch ([#648](https://github.com/jmadibekov/raiko/issues/648)) ([44026aa](https://github.com/jmadibekov/raiko/commit/44026aa29db9bbfc5d4ae5f6aaf2796a1b36b6bf))
* change taiko_hoodi chainid to 167013 ([#638](https://github.com/jmadibekov/raiko/issues/638)) ([56c7270](https://github.com/jmadibekov/raiko/commit/56c7270aabce179662714ebfe771791ac39feb9c))
* fix is_first_shasta block logic to avoid basefee mismatch ([f8b7292](https://github.com/jmadibekov/raiko/commit/f8b7292cbc8936418fbeba938fde4b37006cbd1e))
* Fix shasta ForkCondition ([c4548ba](https://github.com/jmadibekov/raiko/commit/c4548ba85bb398d836309401caff59aa3699b3b8))
* GPU semaphore and bincode fix ([76f481b](https://github.com/jmadibekov/raiko/commit/76f481b08845f66885ce644b66c4f3349e3dbd29))
* grandparent timestamp for chunks ([d8fabe9](https://github.com/jmadibekov/raiko/commit/d8fabe9da5fc401c86315fbfd70203c1d066ca4d))
* grandperent time fix ([5e184b0](https://github.com/jmadibekov/raiko/commit/5e184b04a0fabb87de1b7760f0c0bd68a97c6f62))
* improve validation logic in shasta rules and enhance error logging ([53e7d1c](https://github.com/jmadibekov/raiko/commit/53e7d1c017186d9dae95258894a3dc7295aa45bb))
* proposal_run instaed of batch_run in shasta ([c319243](https://github.com/jmadibekov/raiko/commit/c319243c67d67b1ec17df26d207faa34626f4b82))
* **raiko:** add test & clean code ([605e647](https://github.com/jmadibekov/raiko/commit/605e64756e3889b84808b520eed41ff74e2b41e7))
* **raiko:** make sure the subimage id is constrainted ([#643](https://github.com/jmadibekov/raiko/issues/643)) ([a810671](https://github.com/jmadibekov/raiko/commit/a810671d48522e52ee0f5b57b8621822fbc52dc3))
* **raiko:** update crate dep ([20d20fd](https://github.com/jmadibekov/raiko/commit/20d20fd6d8d4fc8fdf631902e33f1b542d4fe983))
* remove proposal run from mock prover ([35fd86d](https://github.com/jmadibekov/raiko/commit/35fd86d2ce176208f2dcde3442a680a394246579))
* shasta aggregation signs commitment in mock proof ([081ee2b](https://github.com/jmadibekov/raiko/commit/081ee2b235a1b0b719d138bb096364183b6982ec))
* small || fix ([ae2ff31](https://github.com/jmadibekov/raiko/commit/ae2ff31ed47ca4560307aa28d4386cfa4e9ba96f))
* small test fix ([df11771](https://github.com/jmadibekov/raiko/commit/df1177111083dcf78107d4da9561a7d70bcd1d60))
* surge forks fix ([9488631](https://github.com/jmadibekov/raiko/commit/9488631beeb60b9ed54bc006351d7991f741f99c))
* update devnet configuration and enhance Shasta propose event ([8919ea4](https://github.com/jmadibekov/raiko/commit/8919ea4177dbf933036254bf28aa27975f9d3b1b))
* update L1 contract structure in chain specification and adjust SGX proof length for Shasta aggregation ([de80917](https://github.com/jmadibekov/raiko/commit/de80917590331f7ae9a2029713cad9f2212acfed))
* update L1 contract structure in chain specification and adjust SGX proof length for Shasta aggregation ([e403c50](https://github.com/jmadibekov/raiko/commit/e403c5081cba8155879bd17136f13ef37f05f150))
* update SGX MRENCLAVE and SGXGETH MRENCLAVE values in .env ([4f94d5b](https://github.com/jmadibekov/raiko/commit/4f94d5b566f9cad38e9d5287d9fdba8fcf8b1485))
* update SGXGETH MRENCLAVE value in .env and sync submodule reference ([4f8b5ef](https://github.com/jmadibekov/raiko/commit/4f8b5efdd080118df632a66da8eea3908052f32d))
* update Shasta activation check to use timestamp instead of block number ([b7cbf9d](https://github.com/jmadibekov/raiko/commit/b7cbf9dab543954e5357f6203bbb1b1dd168f3df))
* update Shasta activation check to use timestamp instead of block number ([0556f3d](https://github.com/jmadibekov/raiko/commit/0556f3d103d8ac343769c4f007e9a6833cda88a6))
